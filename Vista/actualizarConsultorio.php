...
{ if($resultado->num_rows >0 ){?>
 ...
 <table class="table table-hover text-center mt-3">
  <thead>
        <th class="text-center">Nombre de Consultorio</th>      
      </thead>
 <?php
...
?>
  <tr>
    ...
    <td> <a href="index2.php?pag=editarConsultorio&idConsultorio=<?php echo $registro->idConsultorio?>">
...
<?php 
}else{  echo '<div class="alert alert-danger text-center">El Consultorio referenciado, no existe en la base de datos</div>';}
}
}
?>
<?php
if($msj==1){
  ...
  alert("Los Datos del Consultorio Fueron Actualizados");
